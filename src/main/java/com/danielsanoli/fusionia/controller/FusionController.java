...
public class FusionController {
    ...
    public ImageResponse getImage(@PathVariable UUID id) {
        ...
        String message = switch (fusion.provider()) {
            case "stub" -> "Image generation is currently served by the stub provider. No binary image is generated yet.";
            case "openai" -> fusion.imageUrl() != null
                    ? "Image generated by OpenAI. Use imageUrl to access the generated asset."
                    : "Image generated by OpenAI and returned as base64 payload.";
            default -> "Image information returned by provider %s.".formatted(fusion.provider());
        };
